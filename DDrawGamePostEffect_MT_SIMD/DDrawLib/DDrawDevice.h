...
class CDDrawDevice
{
	...
	char*	m_pPostEffectBuffer = nullptr;
	DWORD	m_dwPostEffectBufferWidth = 0;
	DWORD	m_dwPostEffectBufferHeight = 0;
	...
	CImageProcessor* m_pCurImageProcessr = nullptr;
...
public:
	...
	BOOL	BeginDraw(BOOL bUsePostEffect, CImageProcessor* pImageProcessor);
	void	EndDraw();
